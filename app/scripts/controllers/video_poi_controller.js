 ...
 */
app.controller('videoPoiCtrl', ['rootService', 'videoService', 'videoServiceData', 'userServiceData', 'locationServiceData', 'locationService','commentsService', 'commentsServiceData', 'ratingService', 'ratingServiceData', '$timeout', '$routeParams', '$location', '$scope',
  function (rootService, videoService, videoServiceData, userServiceData, locationServiceData, locationService, commentsService, commentsServiceData, ratingService, ratingServiceData, $timeout, $routeParams, $location, $scope) {
  ...
  vm.videosFiltered = [];
  vm.cities = [];
  vm.headerTitle = $routeParams.place_id.replace(/_/g, ' - ');

  videoService.getVideoListByPlace($routeParams.place_id);

  commentsService.getComments();

  locationService.getPoiById($routeParams.poi_id);
  ...
  function getVideos() {
    ...
    if (userServiceData.users.admin === true) {
      ...
      console.log(videoServiceData.videoListByPoi);
      vm.videosFiltered = videoServiceData.videoListByPoi.videos;
      return vm.videosFiltered;

    } else if (userServiceData.users.admin === false) {
      vm.videosFiltered = videoServiceData.videoListByPoi.videos.filter(function (video) {
